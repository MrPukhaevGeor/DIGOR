                ...
                if (context.locale == const Locale('ru', 'RU')) ...[
                  ...
                  const _dictionaryWidget(
                    ...
                    description: 'Количество статей                 18780\n'
                        ...
                        'Состояние                    включен ✅\n'
                        'Озвучка                      планируется',
                    author: 'Словарь дигорского языкового корпуса. <ref>http://corpus-digor.ossetic-studies.org</ref>',
                  ),
                  const SizedBox(height: 40),
                  const _dictionaryWidget(
                ...
                if (context.locale == const Locale('tr', 'TR')) ...[
                  ...
                  const _dictionaryWidget(
                    ...
                    description: 'Makale sayısı                   26775\n'
                        ...
                        'Durum                           aktif <a>✅</a>\n'
                        'Ses                            planlandı',
                    author: 'Bigulaev B., Gagkaev K., Guriev T., Kulaev N., Tuaeva O., 5. Baskı. - Vladikavkaz, 2004.',
                  ),
                  const SizedBox(height: 40),
                  const _dictionaryWidget(
