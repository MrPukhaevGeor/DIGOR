        ...
        body: Column(
          ...
          children: [
            Padding(
              ...
              child: Text(tr('common'), style: theme.textTheme.bodyMedium!.copyWith(color: Colors.blue)),
            ),
            Container(
              decoration: BoxDecoration(border: Border(bottom: BorderSide(color: Colors.grey.withOpacity(0.3)))),
              child: ListTile(
                title: Text(tr('language'), style: theme.textTheme.bodyMedium!.copyWith(fontSize: 16)),
                onTap: () async {
                  final theme = Theme.of(context);
                            ...
                            return Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child:
                                      Text(tr('language'), style: theme.textTheme.bodyMedium!.copyWith(fontSize: 20)),
                                ),
                                ListTile(
                                  ...
                                  onTap: () {
                                    ref
                                        ...
                                        .onChangeLocale(LocalizationLanguage.system);
                                    Navigator.of(context).pop(LocalizationLanguage.system);
                                  },
                                  leading: Radio(
                                ...
                                ListTile(
                                  ...
                                  onTap: () {
                                    ...
                                    Navigator.of(context).pop(LocalizationLanguage.digor);
                                  },
                                  leading: Radio(
                                    fillColor: MaterialStateProperty.resolveWith<Color>((states) {
                                      if (states.contains(MaterialState.selected)) {
                                ...
                                ListTile(
                                  ...
                                  onTap: () {
                                    ...
                                    Navigator.of(context).pop(LocalizationLanguage.iron);
                                  },
                                  leading: Radio(
                                    fillColor: MaterialStateProperty.resolveWith<Color>((states) {
                                      if (states.contains(MaterialState.selected)) {
                                ...
                                ListTile(
                                  ...
                                  onTap: () {
                                    ...
                                    ref
                                        .read(localizationModeProvider.notifier)
                                        .onChangeLocale(LocalizationLanguage.russian);
                                    Navigator.of(context).pop(LocalizationLanguage.russian);
                                  },
                                  leading: Radio(
                                    groupValue: currentLocalizationMode,
                                ...
                                ListTile(
                                  ...
                                  onTap: () {
                                    ...
                                    ref
                                        .read(localizationModeProvider.notifier)
                                        .onChangeLocale(LocalizationLanguage.english);
                                    Navigator.of(context).pop(LocalizationLanguage.english);
                                  },
                                  leading: Radio(
                                    groupValue: currentLocalizationMode,
                                ...
                                ListTile(
                                  ...
                                  onTap: () {
                                    ...
                                    ref
                                        .read(localizationModeProvider.notifier)
                                        .onChangeLocale(LocalizationLanguage.turkish);
                                    Navigator.of(context).pop(LocalizationLanguage.turkish);
                                  },
                                  leading: Radio(
                                    fillColor: MaterialStateProperty.resolveWith<Color>((states) {
                                      if (states.contains(MaterialState.selected)) {
            ...
            Container(
              decoration: BoxDecoration(border: Border(bottom: BorderSide(color: Colors.grey.withOpacity(0.3)))),
              child: ListTile(
                  title: Text(tr('theme'), style: theme.textTheme.bodyMedium!.copyWith(fontSize: 16)),
                  onTap: () => showDialog(
                      context: context,
                      builder: (context) {
                        return Dialog(
            ...
            Padding(
              padding: const EdgeInsets.only(top: 15, left: 15),
              child: Text(tr('glossary'), style: theme.textTheme.bodyMedium!.copyWith(color: Colors.blue)),
            ),
            ListTile(
                visualDensity: const VisualDensity(vertical: -.3),
                title: Text(tr('font_size'), style: theme.textTheme.bodyMedium!.copyWith(fontSize: 16)),
                onTap: () => showDialog(
                    context: context,
                    builder: (context) {
                      return Dialog(
                        ...
                        child: Consumer(builder: (context, ref, child) {
                          return Column(
                            ...
                            children: [
                              Padding(
                                padding: const EdgeInsets.only(left: 20, top: 16, bottom: 8),
                                child: Text(tr('font_size'), style: theme.textTheme.bodyMedium!.copyWith(fontSize: 20)),
                              ),
                              ListTile(
                                visualDensity: const VisualDensity(vertical: -.3),
                                contentPadding: const EdgeInsets.only(left: 8),
